    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        await _dataSeeder.SeedAsync(new DataSeedContext(tenant?.Id)
            .WithProperty(IdentityDataSeedContributor.AdminEmailPropertyName,
                IdentityConsts.AdminEmailDefaultValue)
            .WithProperty(IdentityDataSeedContributor.AdminPasswordPropertyName,
                IdentityConsts.AdminPasswordDefaultValue)
        );
    }
    ...
    private bool MigrationsFolderExists()
    {
        ...
        return dbMigrationsProjectFolder != null &&
               (Directory.Exists(Path.Combine(dbMigrationsProjectFolder, "Migrations")) ||
                Directory.Exists(Path.Combine(dbMigrationsProjectFolder, "EntityFrameworkCore", "Migrations")));
    }
